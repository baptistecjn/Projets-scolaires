...
post http://localhost:3000/users 201 "firstname=John&lastname=Doe&age=23&password=secret123"
post http://localhost:3000/users 201 "firstname=Janette&lastname=Doe&age=32&password=pass456"
