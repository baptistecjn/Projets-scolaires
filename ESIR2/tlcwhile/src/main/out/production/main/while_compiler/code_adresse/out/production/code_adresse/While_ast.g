...
command
    ...
    | IF expression THEN commands (ELSE commands)? FI  -> ^(IF expression ^(BLOCK commands) ^(ELSE commands)?)
      
    | WHILE expression DO commands OD -> ^(WHILE expression ^(BLOCK commands))
      
    | FOR expression DO commands OD -> ^(FOR expression ^(BLOCK commands))
      
    | FOREACH VARIABLE IN expression DO commands OD -> ^(FOREACH VARIABLE expression ^(BLOCK commands));
